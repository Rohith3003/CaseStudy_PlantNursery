...
/**
 * This class provides Mockito test cases for FertilizerService.
 * 
...
class FertilizerServiceMockitoTest {
	...
	void getAllFertilizersTest() {
		...
		Fertilizer fertilizer1 = new Fertilizer(2, "cow manure", "www.google.com/cowManure", 250,
				"It is an organic fertilizer and manure containing essential nutrients for healthy growth of plants.",
				"1KG");
		Fertilizer fertilizer2 = new Fertilizer(3, "Leaf mould", "www.google.com/leafMould", 189,
				...
				"1KG");
		Fertilizer fertilizer3 = new Fertilizer(1, "compost", "www.google.com/compost", 49.99,
				...
				"1KG");
		Fertilizer fertilizer4 = new Fertilizer(5, "plant food", "www.google.com/plantfood", 549.99,
				" Plant food is a manure or mixture of nitrates which are added to soil, to make fertile.", "2KG");
	...
	public void updatePriceByIdTest() {
		Fertilizer fertilizer = new Fertilizer(3, "Leaf mould", "www.google.com/leafMould", 189,
				"It is a form of compost exclusively made by the fungal & bacterial breakdown of dry leaves. Leaf mould is good quality humus.",
				"1KG");
		Fertilizer fertilizer2 = new Fertilizer(3, "Leaf mould", "www.google.com/leafMould", 200,
				"It is a form of compost exclusively made by the fungal & bacterial breakdown of dry leaves. Leaf mould is good quality humus.",
				"1KG");
	...
	public void removeFertilizerByNameTest() {
		...
		Fertilizer deletedFertilizer = fertilizerService.removeFertilizerByName(23, "Leaf mould");
		assertEquals(fertilizer, deletedFertilizer);
