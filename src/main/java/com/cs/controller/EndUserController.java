...
public class EndUserController {
	...
	ResponseEntity<String> updateCustomerPassword(@Valid @RequestParam String email,@RequestParam String oldPassword,@RequestParam String newPassword,@RequestParam String confirmNewPassword){
